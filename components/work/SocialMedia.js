    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex justify-center items-center mt-10">
        <button
          ...
          className="bg-black hover:bg-transparent hover:text-black text-white px-6 py-3 cursor-pointer hover:scale-105 transition-transform duration-300 rounded-md font-medium text-[16px] md:text-[18px] lg:text-[22px]"
        >
