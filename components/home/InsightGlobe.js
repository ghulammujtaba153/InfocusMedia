  ...
  return (
    <section className="relative z-10 bg-white min-h-screen overflow-hidden">
      ...
      >
        ...
        <div className="fle flex-col leading-[.95]">
      ...
      >
        <p className="md:text-[18px] text-[16px] lg:text-[22px] font-bold uppercase font-bandeins-strange text-black text-center">
          We don't see brands, we see possibilities
        </p>
        <div className="flex flex-col leading-[.95]">
          <h1 className="font-bold font-bandeins-strange text-black text-center text-[40px] md:text-[65px] lg:text-[100px]">
            We transform ideas
          </h1>
          <h1 className="font-bold font-bandeins-strange text-black text-center text-[40px] md:text-[65px] lg:text-[100px]">
            into visual stories
        ...
        <p className=" font-bold uppercase font-bandeins-strange mt-4 text-black text-center mb-12 rounded-md md:text-[18px] text-[16px] lg:text-[22px]">
