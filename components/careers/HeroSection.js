...
const HeroSection = () => {
  return (
    <div className='bg-[#FAFAFA] py-20 px-6 h-screen flex gap-5 md:mt-0 mt-20 md:flex-row flex-col item-center'>
        ...
        <div className='md:w-1/2 flex flex-col justify-end'>
            <h1 className='text-xl font-semibold text-[16px] md:text-[18px] lg:text-[22px] uppercase'>we’re always on the lookout for brilliant minds and bold ideas. check out our vacancies and apply for the one that suits you best!</h1>
