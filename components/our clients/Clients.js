...
const Clients = () => {
  const clients = [
    ...
    { name: "Client 6", logo: "/assets/Clients/client1.png" }, 
    { name: "Client 7", logo: "/assets/Clients/Frame 278.png" }, 
    { name: "Client 8", logo: "/assets/Clients/Frame 256-1.png" }, 
    { name: "Client 9", logo: "/assets/Clients/Frame 257-1.png" }, 
    { name: "Client 10", logo: "/assets/Clients/Frame 258-1.png" }, 

    { name: "Client 11", logo: "/assets/Clients/client2.png" },
    { name: "Client 12", logo: "/assets/Clients/Frame 265.png" },
    { name: "Client 23", logo: "/assets/Clients/Frame 261.png" }, 
    { name: "Client 13", logo: "/assets/Clients/Frame 262.png" }, 
    { name: "Client 14", logo: "/assets/Clients/Frame 263.png" }, 


    { name: "Client 15", logo: "/assets/Clients/client3.png" },
    { name: "Client 16", logo: "/assets/Clients/Frame 265.png" }, 
    { name: "Client 17", logo: "/assets/Clients/Frame 266.png" }, 
    { name: "Client 18", logo: "/assets/Clients/Frame 267.png" },
    { name: "Client 19", logo: "/assets/Clients/Frame 268.png" },

    { name: "Client 20", logo: "/assets/Clients/client4.png" },
    { name: "Client 21", logo: "/assets/Clients/Frame 270.png" },
    { name: "Client 2", logo: "/assets/Clients/Frame 254.png" },
    { name: "Client 12", logo: "/assets/Clients/Frame 277.png" },
    { name: "Client 11", logo: "/assets/Clients/Frame 273.png" },

    { name: "Client 25", logo: "/assets/Clients/client5.png" },
